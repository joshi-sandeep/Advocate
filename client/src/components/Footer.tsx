...
export default function Footer() {
  return (
    <footer className="bg-primary text-primary-foreground mt-8 md:mt-16">
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="border-t border-primary-foreground/20 mt-6 md:mt-8 pt-6 md:pt-8 text-center text-sm md:text-base">
